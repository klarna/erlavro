...
avro_schema_promotable_primitive_test() ->
  ?assert(avro:is_compatible(mkschema(primitive_type(long)),
                               mkschema(primitive_type(int)))),
  ?assert(avro:is_compatible(mkschema(primitive_type(float)),
                               mkschema(primitive_type(int)))),
  ?assert(avro:is_compatible(mkschema(primitive_type(double)),
                                 mkschema(primitive_type(int)))),
  ?assert(avro:is_compatible(mkschema(primitive_type(float)),
  ...
  ?assert(avro:is_compatible(mkschema(primitive_type(bytes)),
                                 mkschema(primitive_type(string)))),
