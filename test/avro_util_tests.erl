...
avro_schema_compatible_primitive_test() ->
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(int)),
                               mkschema(primitive_type(int)))),
  ?assertNot(avro_util:avro_schema_compatible(mkschema(primitive_type(int)),
                                  mkschema(primitive_type(string)))).

avro_schema_promotable_primitive_test() ->
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(long)),
                               mkschema(primitive_type(int)))),
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(float)),
                               mkschema(primitive_type(int)))),
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(double)),
                                 mkschema(primitive_type(int)))),
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(float)),
  ...
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(bytes)),
                                 mkschema(primitive_type(string)))),
  ?assert(avro_util:avro_schema_compatible(mkschema(primitive_type(string)),
                                 mkschema(primitive_type(bytes)))),
  ?assertNot(avro_util:avro_schema_compatible(mkschema(primitive_type(string)),
                                    mkschema(primitive_type(int)))).
...
avro_schema_compatible_array_test() ->
  ...
  ?assert(avro_util:avro_schema_compatible(Reader, Writer)),
  ?assertNot(avro_util:avro_schema_compatible(Reader, Writer2)),
  ?assertNot(
     avro_util:avro_schema_compatible(
